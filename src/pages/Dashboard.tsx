  ...
  const fetchEmails = async () => {
    try {
      ...
      if (user?.authProvider === "google") {
        response = await axios.get(`${API_BASE_URL}/emails/gmail`, {
          withCredentials: true,
        });
      } else if (user?.authProvider === "microsoft") {
        response = await axios.get(`${API_BASE_URL}/emails/outlook`, {
          withCredentials: true,
        });
      } else {
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full bg-white border border-gray-300 rounded-md py-2 px-3 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm flex justify-between items-center"
                    >
            ...
            <div className="overflow-y-auto max-h-60 rounded-md border border-gray-200">
              {emailsLoading ? (
                    ...
                    <li key={email.id} className="py-3 px-4 hover:bg-gray-50 transition-colors duration-150">
                      <div className="flex justify-between">
                        ...
                        <button
                          ...
                          className="ml-2 text-blue-600 hover:text-blue-800 self-start"
                        >
                ...
                <div className="py-8 text-center">
                  ...
                  <button
                    onClick={fetchEmails}
                    className="mt-2 inline-flex items-center px-3 py-1 text-xs font-medium text-blue-700 hover:text-blue-900"
                  >
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                >
                  {example}
                </button>
              ))}
